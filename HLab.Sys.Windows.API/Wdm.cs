...
public static partial class Wdm
{
    ...
    public static extern uint ZwQueryKey(nint hKey, KeyInformationClass KeyInformationClass, nint lpKeyInformation, int Length, out int ResultLength);
}