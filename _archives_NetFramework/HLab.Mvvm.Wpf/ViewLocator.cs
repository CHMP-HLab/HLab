...
using H = HLab.Base.Wpf.DependencyHelper<HLab.Mvvm.Wpf.ViewLocator>;
namespace HLab.Mvvm.Wpf
{
    ...
    public class ViewLocator : UserControl
    {
        ...
        public MvvmContext MvvmContext
        {
            get => (MvvmContext)GetValue(MvvmContextProperty);
